...
#include  <memory>
namespace bnet { namespace exception_detail { using std::shared_ptr; } }
#else
namespace bnet { template <class T> class shared_ptr; }
namespace bnet { namespace exception_detail { using bnet::shared_ptr; } }
#endif
...
bnet
    ...
    exception_detail
        ...
        bnet::source_location get_exception_throw_location( exception const & );
        }
    ...
    exception
...
#ifdef __HP_aCC
        //On HP aCC, this protected copy constructor prevents throwing bnet::exception.
        ...
        friend bnet::source_location exception_detail::get_exception_throw_location( exception const & );
    ...
    exception_detail
        ...
        inline bnet::source_location get_exception_throw_location( exception const & x )
            {
