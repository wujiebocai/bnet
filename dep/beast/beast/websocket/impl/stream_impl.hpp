...
#include <beast/beast/websocket/rfc6455.hpp>
#include <beast/beast/websocket/detail/frame.hpp>
#include <beast/beast/websocket/detail/hybi13.hpp>
#include <beast/beast/websocket/detail/mask.hpp>
#include <beast/beast/websocket/detail/pmd_extension.hpp>
#include <beast/beast/websocket/detail/prng.hpp>
#include <beast/beast/websocket/detail/service.hpp>
#include <beast/beast/websocket/detail/soft_mutex.hpp>
#include <beast/beast/websocket/detail/utf8_checker.hpp>
#include <beast/beast/http/read.hpp>
#include <beast/beast/http/write.hpp>
#include <beast/beast/http/rfc7230.hpp>
#include <beast/beast/core/buffers_cat.hpp>
#include <beast/beast/core/buffers_prefix.hpp>
#include <beast/beast/core/buffers_suffix.hpp>
#include <beast/beast/core/flat_static_buffer.hpp>
#include <beast/beast/core/saved_handler.hpp>
#include <beast/beast/core/static_buffer.hpp>
#include <beast/beast/core/stream_traits.hpp>
#include <beast/beast/core/detail/clamp.hpp>
#include <asio/steady_timer.hpp>
#include <beast/core/empty_value.hpp>
//#include <beast/enable_shared_from_this.hpp>
//#include <beast/shared_ptr.hpp>
#include <optional>
#include <memory>
    ...
    , detail::impl_base<deflateSupported>
{
    ...
    impl_type(Args&&... args)
        ...
        , detail::service::impl_type(
            this->get_context(
                this->bnet::empty_value<NextLayer>::get().get_executor()))
        , timer(this->bnet::empty_value<NextLayer>::get().get_executor())
    {
