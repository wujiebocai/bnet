...
#include <beast/beast/core/buffer_traits.hpp>
#include <beast/beast/websocket/teardown.hpp>
#include <beast/beast/websocket/detail/mask.hpp>
#include <beast/beast/websocket/impl/stream_impl.hpp>
...
#include <beast/beast/core/read_size.hpp>
#include <beast/beast/core/stream_traits.hpp>
#include <beast/beast/core/detail/bind_continuation.hpp>
#include <beast/beast/core/detail/buffer.hpp>
...
public:
        ...
        bool cont = true)
    {
        ...
        ASIO_CORO_REENTER(*this)
        {
            do
            {
                // VFALCO TODO use bnet::beast::bind_continuation
                ASIO_CORO_YIELD
                {
