...
teardown(
    ...
    error_code& ec)
{
    bnet::ignore_unused(role, socket, ec);
/*
    If you are trying to use OpenSSL and this goes off, you need to
    add an include for <beast/beast/websocket/ssl.hpp>.
...
{
    bnet::ignore_unused(role, socket, handler);
/*
    If you are trying to use OpenSSL and this goes off, you need to
    add an include for <beast/beast/websocket/ssl.hpp>.
...
#include <beast/beast/websocket/impl/teardown.hpp>
