...
#include <beast/beast/zlib/error.hpp>
#include <beast/beast/zlib/zlib.hpp>
#include <beast/beast/zlib/detail/bitstream.hpp>
#include <beast/beast/zlib/detail/ranges.hpp>
#include <beast/beast/zlib/detail/window.hpp>
#if 0
#include <beast/beast/core/detail/type_traits.hpp>
