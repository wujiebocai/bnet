...
#include <beast/beast/http/fields.hpp>
#include <beast/beast/http/verb.hpp>
#include <beast/beast/http/status.hpp>
#include <beast/beast/http/type_traits.hpp>
...
private:
    ...
    message(
        ...
        : bnet::empty_value<
            typename Body::value_type>(bnet::empty_init_t(),
                std::forward<BodyArgs>(
                std::get<IBodyArgs>(body_args))...)
    {
        bnet::ignore_unused(body_args);
    }
    ...
    {
        bnet::ignore_unused(body_args);
        bnet::ignore_unused(fields_args);
    }
...
#include <beast/beast/http/impl/message.hpp>
