...
// This include is necessary to work with `ssl::stream` and `bnet::beast::websocket::stream`
#include <beast/beast/websocket/ssl.hpp>

#include <beast/beast/core/flat_stream.hpp>
    ...
    : public net::ssl::stream_base
{
    ...
    using stream_type = bnet::beast::flat_stream<ssl_stream_type>;
...
public:
    ...
    */
    ...
    /** Get the underlying implementation in the native type.
        ...
        @code
        bnet::beast::ssl_stream<net::ip::tcp::socket> ss{ioc, ctx};
    ...
    */
    ...
    // These hooks are used to inform bnet::beast::websocket::stream on
