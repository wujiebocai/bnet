...
#include <beast/beast/core/bind_handler.hpp>
#include <beast/beast/core/detail/allocator.hpp>
#include <beast/beast/core/detail/async_base.hpp>
#include <beast/beast/core/detail/filtering_cancellation_slot.hpp>
#include <beast/beast/core/detail/work_guard.hpp>
...
class async_base
    ...
    : private bnet::empty_value<Allocator>
#endif
{
    static_assert(
...
public:
    ...
    If a class derived from @ref bnet::beast::async_base is a completion
...
public:
    ...
    */
    ...
    async_base(
        ...
        : bnet::empty_value<Allocator>(
            bnet::empty_init_t{}, alloc)
        , h_(std::forward<Handler_>(handler))
        , wg1_(ex1)
    {
    }
    ...
    */
    ...
    get_allocator() const noexcept
    {
        return net::get_associated_allocator(h_,
            bnet::empty_value<Allocator>::get());
    }
    ...
    */
    ...
    /** Invoke the final completion handler, maybe using post.
        ...
        @ref bnet::beast::async_base::complete or
        @ref bnet::beast::async_base::complete_now more than once.

        Any temporary objects allocated with @ref bnet::beast::allocate_stable will
        ...
        @ref bnet::beast::async_base::complete_now.
    ...
    */
    ...
    /** Invoke the final completion handler.
        ...
        This invokes the final completion handler with the specified
        arguments forwarded. It is undefined to call either of
        @ref bnet::beast::async_base::complete or @ref bnet::beast::async_base::complete_now more than once.
    ...
    */
    ...
    stable_async_base(stable_async_base&& other)
        : async_base<Handler, Executor1, Allocator>(
            std::move(other))
        , list_(bnet::exchange(other.list_, nullptr))
    {
    }
...
#include <beast/beast/core/impl/async_base.hpp>
