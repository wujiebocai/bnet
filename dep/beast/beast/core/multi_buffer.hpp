...
//#include <beast/intrusive/list.hpp>
#include <beast/type_with_alignment.hpp>
#include <list>
#include <iterator>
#include <limits>
#include <memory>
...
#endif
{
    ...
    class element
        //: public bnet::intrusive::list_base_hook<
        //    bnet::intrusive::link_mode<
        //        bnet::intrusive::normal_link>>
    {
    ...
    //using list_type = typename bnet::intrusive::make_list<
    //    element, bnet::intrusive::constant_time_size<false>>::type;
...
#include <beast/beast/core/impl/multi_buffer.hpp>
