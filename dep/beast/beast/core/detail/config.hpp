...
#define BOOST_BEAST_ASYNC_RESULT1(type) \
    ASIO_INITFN_AUTO_RESULT_TYPE(type, void(::bnet::beast::error_code))
#endif

#ifndef BOOST_BEAST_ASYNC_RESULT2
#define BOOST_BEAST_ASYNC_RESULT2(type) \
    ASIO_INITFN_AUTO_RESULT_TYPE(type, void(::bnet::beast::error_code, ::std::size_t))
#endif

#ifndef BOOST_BEAST_ASYNC_TPARAM1
#define BOOST_BEAST_ASYNC_TPARAM1 ASIO_COMPLETION_TOKEN_FOR(void(::bnet::beast::error_code))
#endif

#ifndef BOOST_BEAST_ASYNC_TPARAM2
#define BOOST_BEAST_ASYNC_TPARAM2 ASIO_COMPLETION_TOKEN_FOR(void(::bnet::beast::error_code, ::std::size_t))
#endif
