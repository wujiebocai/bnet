...
#include <beast/beast/core/detail/stream_base.hpp>
#include <beast/beast/core/error.hpp>
#include <beast/beast/core/rate_policy.hpp>
...
private:
        ...
        , bnet::empty_value<RatePolicy>
    {
        ...
        policy() noexcept
        {
            return this->bnet::empty_value<RatePolicy>::get();
        }
...
#include <beast/beast/core/impl/basic_stream.hpp>
