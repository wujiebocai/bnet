...
basic_flat_buffer(Allocator const& alloc) noexcept
    : bnet::empty_value<base_alloc_type>(
...
basic_flat_buffer(basic_flat_buffer&& other) noexcept
    ...
    , begin_(bnet::exchange(other.begin_, nullptr))
    , in_(bnet::exchange(other.in_, nullptr))
    , out_(bnet::exchange(other.out_, nullptr))
    , last_(bnet::exchange(other.last_, nullptr))
    , end_(bnet::exchange(other.end_, nullptr))
    , max_(other.max_)
{
}
...
basic_flat_buffer(basic_flat_buffer const& other)
    : bnet::empty_value<base_alloc_type>(bnet::empty_init_t{},
