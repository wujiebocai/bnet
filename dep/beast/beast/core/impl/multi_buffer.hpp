...
basic_multi_buffer(
    ...
    : bnet::empty_value<Allocator>(
        bnet::empty_init_t(), std::move(other.get()))
    , max_(other.max_)
    , in_size_(bnet::exchange(other.in_size_, 0))
    , in_pos_(bnet::exchange(other.in_pos_, 0))
    , out_pos_(bnet::exchange(other.out_pos_, 0))
    , out_end_(bnet::exchange(other.out_end_, 0))
{
    auto const at_end =
...
basic_multi_buffer(
    ...
    : bnet::empty_value<Allocator>(
        bnet::empty_init_t(), alloc_traits::
