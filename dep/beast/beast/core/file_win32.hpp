...
#include <beast/beast/core/file_base.hpp>
#include <beast/winapi/basic_types.hpp>
#include <beast/winapi/handles.hpp>
#include <cstdio>
#include <cstdint>
...
public:
...
#else
    using native_handle_type = bnet::winapi::HANDLE_;
#endif
    ...
    */
    ...
    is_open() const
    {
        return h_ != bnet::winapi::INVALID_HANDLE_VALUE_;
    }
