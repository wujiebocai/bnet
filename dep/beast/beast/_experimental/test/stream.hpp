...
#include <beast/beast/core/flat_buffer.hpp>
#include <beast/beast/core/role.hpp>
#include <beast/beast/core/string.hpp>
#include <beast/beast/_experimental/test/fail_count.hpp>
#include <beast/beast/_experimental/test/detail/stream_state.hpp>
...
/** A two-way socket useful for unit testing
    ...
    @ref bnet::beast::http::async_write for example.
...
private:
    ...
    std::shared_ptr<detail::stream_state> in_;
    std::weak_ptr<detail::stream_state> out_;
    ...
    void
    initiate_read(
        std::shared_ptr<detail::stream_state> const& in,
...
#include <beast/beast/_experimental/test/impl/stream.hpp>
