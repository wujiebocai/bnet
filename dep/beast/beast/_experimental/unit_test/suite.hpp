...
#include <beast/beast/_experimental/unit_test/runner.hpp>
...
#ifndef BEAST_PASS
#define BEAST_PASS() ::bnet::beast::unit_test::suite::this_suite()->pass()
#endif

#ifndef BEAST_FAIL
#define BEAST_FAIL() ::bnet::beast::unit_test::suite::this_suite()->fail("", __FILE__, __LINE__)
#endif
...
*/
#define BEAST_EXPECT(cond) ::bnet::beast::unit_test::suite::this_suite()->expect(cond, __FILE__, __LINE__)
#endif
...
#define BEAST_EXPECTS(cond, reason) ((cond) ? \
    (::bnet::beast::unit_test::suite::this_suite()->pass(), true) : \
    (::bnet::beast::unit_test::suite::this_suite()->fail((reason), __FILE__, __LINE__), false))
#endif
...
#define BEAST_DEFINE_TESTSUITE_INSERT(Library,Module,Class,manual) \
    static ::bnet::beast::unit_test::detail::insert_suite <Class##_test>   \
...
#else
#include <beast/beast/_experimental/unit_test/global_suites.hpp>
