...
#include <beast/beast/_experimental/unit_test/amount.hpp>
#include <beast/beast/_experimental/unit_test/dstream.hpp>
#include <beast/beast/_experimental/unit_test/global_suites.hpp>
#include <beast/beast/_experimental/unit_test/match.hpp>
#include <beast/beast/_experimental/unit_test/reporter.hpp>
...
{
    using namespace std;
    using namespace bnet::beast::unit_test;
