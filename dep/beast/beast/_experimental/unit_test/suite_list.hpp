...
#include <beast/beast/_experimental/unit_test/suite_info.hpp>
#include <beast/beast/_experimental/unit_test/detail/const_container.hpp>
#include <beast/assert.hpp>
#include <beast/type_index.hpp>
#include <beast/functional/hash.hpp>
#include <typeindex>
#include <set>
...
private:
    ...
    using type_index = bnet::typeindex::type_index;
    std::unordered_set<type_index, bnet::hash<type_index>> classes_;
#endif
