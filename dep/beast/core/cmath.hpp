...
{
    return bnet::core::isnormal( static_cast<double>( x ) );
}
...
inline int fpclassify( float x )
{
    ...
    default:
        ...
        return bnet::core::isnormal( x )? fp_normal: fp_subnormal;
    }
}
...
{
    return bnet::core::fpclassify( static_cast<double>( x ) );
}
...
template<class T> T copysign( T x, T y )
{
    return bnet::core::detail::copysign_impl( x, y );
}
