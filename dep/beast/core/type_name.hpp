...
// std::string bnet::core::type_name<T>()
//
// Copyright 2021 Peter Dimov
// Distributed under the Boost Software License, Version 1.0.
// https://www.boost.org/LICENSE_1_0.txt

#include <beast/core/demangle.hpp>
...
{
    std::string r = bnet::core::demangle( n );
...
template<> struct tn_holder<bnet::long_long_type>
{
    static std::string type_name( std::string const& suffix )
    {
...
template<> struct tn_holder<bnet::ulong_long_type>
{
    static std::string type_name( std::string const& suffix )
    {
...
template<> struct tn_holder<bnet::int128_type>
{
    static std::string type_name( std::string const& suffix )
    {
...
template<> struct tn_holder<bnet::uint128_type>
{
    static std::string type_name( std::string const& suffix )
    {
