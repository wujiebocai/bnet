...
addressof(T& o) BOOST_NOEXCEPT
{
    ...
    return bnet::detail::addrof<T>::get(o, 0);
#else
    return bnet::detail::addrof<T>::get(bnet::detail::addrof_ref<T>(o), 0);
#endif
}
...
BOOST_FORCEINLINE typename bnet::detail::addrof_result<T[N]>::type
...
addressof(T& o) BOOST_NOEXCEPT
{
    return bnet::detail::addressof(o);
}
#endif
