...
#include <beast/core/max_align.hpp>
...
inline void* operator new( std::size_t, void* p, bnet::core::detail::placement_new_tag )
{
    return p;
}

inline void operator delete( void*, void*, bnet::core::detail::placement_new_tag )
{
}
