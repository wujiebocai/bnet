...
#ifndef BOOST_BEAST_TT_TYPE_WITH_ALIGNMENT_INCLUDED
#define BOOST_BEAST_TT_TYPE_WITH_ALIGNMENT_INCLUDED
...
namespace beast {
   ...
   namespace detail{
      ...
      union max_align
      {
         ...
         bnet::long_long_type ll;
#endif
#ifdef BOOST_HAS_INT128
         bnet::int128_type i128;
#endif
         float f;
         double d;
         long double ld;
...
template <std::size_t Target> struct long_double_alignment<Target, false>{ typedef bnet::beast::detail::max_align type; };
...
#ifndef BOOST_NO_LONG_LONG
template <std::size_t Target, bool check> struct long_long_alignment{ typedef bnet::long_long_type type; };
...
#ifndef BOOST_NO_LONG_LONG
template <std::size_t Target> struct long_alignment<Target, false>{ typedef typename long_long_alignment<Target, std::alignment_of<bnet::long_long_type>::value >= Target>::type type; };
#else
...
{
   typedef typename bnet::beast::detail::char_alignment<Align, std::alignment_of<char>::value >= Align>::type type;
};
...
{ 
   typedef std::conditional<
      std::alignment_of<bnet::beast::detail::max_align>::value < 8,
      tt_align_ns::a8,
      bnet::beast::detail::char_alignment<8, false> >::type t1;
public: 
...
{ 
   typedef std::conditional<
      std::alignment_of<bnet::beast::detail::max_align>::value < 16,
      tt_align_ns::a16,
      bnet::beast::detail::char_alignment<16, false> >::type t1;
public: 
   typedef t1::type type;
};
...
{ 
   typedef std::conditional<
      std::alignment_of<bnet::beast::detail::max_align>::value < 32,
      tt_align_ns::a32,
      bnet::beast::detail::char_alignment<32, false> >::type t1;
public: 
   typedef t1::type type;
};
template<> struct type_with_alignment<64> {
   typedef std::conditional<
      std::alignment_of<bnet::beast::detail::max_align>::value < 64,
      tt_align_ns::a64,
      bnet::beast::detail::char_alignment<64, false> >::type t1;
public: 
   typedef t1::type type;
};
template<> struct type_with_alignment<128> {
   typedef std::conditional<
      std::alignment_of<bnet::beast::detail::max_align>::value < 128,
      tt_align_ns::a128,
      bnet::beast::detail::char_alignment<128, false> >::type t1;
public: 
   typedef t1::type type;
};
