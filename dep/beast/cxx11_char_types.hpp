...
//                                                                                      //
//  The emulation names are placed in namespace bnet, as is usual for Boost C++11      //
//  emulation names such as those in header <beast/cstdint.hpp>.                        //
//                                                                                      //
...
//   Boost               C++11            C++03                                         //
//   ----------------    --------------   --------------------------------              //
//   bnet::char16       char16_t         uint16_t                                      //
//   bnet::char32       char32_t         uint32_t                                      //
//   bnet::u16string    std::u16string   std::basic_string<bnet::char16>              //
//   bnet::u32string    std::u32string   std::basic_string<bnet::char32>              //
//                                                                                      //
...
# if defined(BOOST_NO_CXX11_CHAR16_T) && (!defined(_MSC_VER) || _MSC_VER < 1600)  // 1600 == VC++10
    typedef bnet::uint_least16_t             char16;
    typedef std::basic_string<bnet::char16>  u16string;
# else
...
# if defined(BOOST_NO_CXX11_CHAR32_T) && (!defined(_MSC_VER) || _MSC_VER < 1600)  // 1600 == VC++10
    typedef  bnet::uint_least32_t            char32;
    typedef std::basic_string<bnet::char32>  u32string;
# else
