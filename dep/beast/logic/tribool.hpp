...
#include <beast/logic/tribool_fwd.hpp>
...
namespace bnet { namespace logic {
...
inline bool                                                             \
Name(bnet::logic::tribool x,                                           \
     bnet::logic::detail::indeterminate_t =                            \
       bnet::logic::detail::indeterminate_t())                         \
{ return x.value == bnet::logic::tribool::indeterminate_value; }
